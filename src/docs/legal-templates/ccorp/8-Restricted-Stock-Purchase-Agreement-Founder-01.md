...
2.  The property with respect to which the election is made is described as follows: [Shares-amount] shares (the "**_Shares_**") of the Common Stock of [Company-name] (the "**_Company_**").
